-- Fix Prisma multi-schema enums placement.
-- Prisma expects:
--   auth."PlatformRole", auth."AccountState"
--   notifications."NotificationType"
-- but previous migrations created enum types in `main`.
...
ALTER TABLE auth.accounts ALTER COLUMN role SET DEFAULT 'USER'::auth."PlatformRole";
...
ALTER TABLE auth.accounts ALTER COLUMN state SET DEFAULT 'ACTIVE'::auth."AccountState";
