...
export class PostController {
  ...
  @Get('feed')
  getFeed(@CurrentUser() user: ICurrentUser, @Query() pagination: PaginationDto) {
  ...
  @Patch(':id')
  update(@CurrentUser() user: ICurrentUser, @Param('id') id: string, @Body() updatePostDto: UpdatePostDto) {
